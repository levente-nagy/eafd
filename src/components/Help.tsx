    ...
    return (
        <div className='help'>
            ...
            <ul>
                ...
                <li>Contact: If you have any questions, feel free to reach out to us here.</li>
                <li>Help: You are here.</li>
                <li>Search: Search for articles by keyword</li>
                <li>Scroll to top: Click on the arrow button on the right side to scroll back to the top of the page.</li>
